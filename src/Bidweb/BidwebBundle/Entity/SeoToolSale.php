...
/**
 * Category
 * @ORM\Entity(repositoryClass="Bidweb\BidwebBundle\Repository\SEOToolRepository")
 * @ORM\Table(name="seo_tool_sale")
...
class SeoToolSale {
     ...
     * @var string
     *
     * @ORM\Column(name="demo", type="string", length=255, nullable=true)
     */
    private $demo;
