...
/**
 * Category
 * @ORM\Entity(repositoryClass="Bidweb\BidwebBundle\Repository\DatabaseRepository")
 * @ORM\Table(name="database_sale")
...
class DatabaseSale {
     ...
     * @var string
     *
     * @ORM\Column(name="taxonomy", type="string", length=100, nullable=true)
     */
    private $taxonomy;
   ...
   /**
     *
     * @var string
     * @ORM\Column(name="demo", type="string", length=1000, nullable=true) 
     */
    private $demo;
