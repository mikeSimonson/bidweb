...
/**
 * Category
 * @ORM\Entity(repositoryClass="Bidweb\BidwebBundle\Repository\DomainRepository")
 * @ORM\Table(name="domain_sale")
...
class DomainSale {
   ...
   /**
     * @var integer
     *
     * @ORM\Column(name="daily_visitor", type="integer")
     */
    private $dailyVisitor;
     ...
     * Set dailyVisitor
     *
     * @param integer $dailyVisitor
     *
     * @return DomainSale
     */
    public function setDailyVisitor($dailyVisitor)
    {
