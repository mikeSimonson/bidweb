...
(function ($) {
    ...
    function CloudZoom(jWin, opts) {
        ...
        setTimeout(function () {
            ...
            if ($mouseTrap === null) {
                var w = jWin.width();
                jWin.parent().append(format('<div style="top:75%;left:%1px;" class="cloud-zoom-loading" >yükleniyor...</div>', w / 3, (w / 2) - (w / 6))).find(':last').css('opacity', 0.5);
            }
        }, 200);
